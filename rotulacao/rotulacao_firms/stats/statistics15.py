...
if __name__ == '__main__':
    ...
    file['frp_mean_15'] = frp_mean
    file['frp_variance_15'] = frp_variance
    file['frp_std_15'] = frp_std

    file['brightness_mean_15'] = brightness_mean
    file['brightness_variance_15'] = brightness_variance
    file['brightness_std_15'] = brightness_std

    file['bright_t31_mean_15'] = bright_t31_mean
    file['bright_t31_variance_15'] = bright_t31_variance
    file['bright_t31_std_15'] = bright_t31_std    
