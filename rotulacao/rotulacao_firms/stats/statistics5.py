...
if __name__ == '__main__':
    ...
    file['frp_mean_5'] = frp_mean
    file['frp_variance_5'] = frp_variance
    file['frp_std_5'] = frp_std

    file['brightness_mean_5'] = brightness_mean
    file['brightness_variance_5'] = brightness_variance
    file['brightness_std_5'] = brightness_std

    file['bright_t31_mean_5'] = bright_t31_mean
    file['bright_t31_variance_5'] = bright_t31_variance
    file['bright_t31_std_5'] = bright_t31_std    
