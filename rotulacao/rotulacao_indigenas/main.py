...
if __name__ == "__main__":
    ...
    end = '/home/scholles/Desktop/CENSIPAM/Codigos/queimadas_datasets/rotulacao/rotulacao_indigenas/shape/tis_poligonais.shp'
    ...
    for i in range(len(latitudeList)):
        ...
        print(round((i/len(latitudeList)*100),2), '%')
        if i in index:
            reservaIndigena.append(1)
        else:
            reservaIndigena.append(0)
    
    df['Reserva Indigena'] = reservaIndigena
