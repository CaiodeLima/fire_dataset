...
nomeArquivo = '/home/scholles/Desktop/CENSIPAM/Codigos/queimadas_datasets/train/2014.csv'        # Sempre adequar ao path do seu computador
nomeBackup = '/home/scholles/Desktop/CENSIPAM/Codigos/queimadas_datasets/train/Backup.csv'       # Sempre adequar ao path do seu computador
pathMethData = '/home/scholles/Desktop/CENSIPAM/Codigos/queimadas_datasets/rotulacao/rotulacao_meteorology/meteorologyData/2014/2014meteorology.csv'
...
if __name__ == '__main__':
    ...
    for i in range(len(focosCSV)):
        for j in range(len(column)):
            ...
            countBack +=1
            try:
                focosCSV.loc[i, column[j]], focosCSV.loc[i, 'umidadeEspecifica_def'], focosCSV.loc[i, 'temperaturaMaxima_def'], focosCSV.loc[i, 'temperaturaMinima_def'] = find_meth_data(focosCSV['longitude'].iloc[i], focosCSV['latitude'].iloc[i], focosCSV['ano'].iloc[i], focosCSV['mes'].iloc[i], focosCSV['dia'].iloc[i])
            except:
